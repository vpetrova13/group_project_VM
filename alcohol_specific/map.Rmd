...
final_final_data %>% 
  ...
  mutate(show_edge = hb_assign == "S08000031") %>% 
...
```{r}
write_csv(final_data, "alcoholic_clean_geo_data.csv")
write_csv(final_final_data, "alcoholic_geographic_data.csv")
```
